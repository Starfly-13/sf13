...
/obj/item/toy/cards/deck/cas
	...
	var/blanks = 25
	var/decksize = 150
	var/card_text_file = CARDS_AGAINST_SPESS_WHITE_TXT
...
/obj/item/toy/cards/deck/cas/black
	...
	blanks = 0
	decksize = 50
	card_text_file = CARDS_AGAINST_SPESS_BLACK_TXT

/obj/item/toy/cards/deck/cas/populate_deck()
	var/static/list/cards_against_space = list("cas_white" = world.file2list(CARDS_AGAINST_SPESS_WHITE_TXT),"cas_black" = world.file2list(CARDS_AGAINST_SPESS_BLACK_TXT))
