# Cryosleep Symptoms Flag

Module ID: `CRYOSLEEP_SYMPTOMS_FLAG`

## Description

Adds a configuration flag allowing cryosleep symptoms to be applied or not
when characters enter the game.
